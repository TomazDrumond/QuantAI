...
def plotar_curva_patrimonio_e_drawdown(
    ...
    ax1.set_title("Evolução de Patrimônio Acumulado — Quant AI (2018-2026)", fontsize=14, fontweight='bold', pad=12)
...
def plotar_alocacao_pesos_historica(
    ...
    ax.set_title("Evolução Histórica da Alocação de Pesos da Carteira (2018-2026)", fontsize=14, fontweight='bold', pad=12)
